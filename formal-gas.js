...
const ALLOWED_ACTIONS = new Set(['initializeFormalDatabase', 'getHomeData', 'getRecords', 'getAudit', 'getHandlers', 'addOpening', 'closePeriod', 'addAdvance', 'settleAdvance', 'addDirectExpense', 'addReplenishment', 'addCount', 'resolveCount', 'confirmSync', 'createCorrection']);
